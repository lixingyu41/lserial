...
class _DownloadClientButton extends StatelessWidget {
  ...
  static final List<_DownloadTarget> _targets = [
    _DownloadTarget(
      ...
      url: Uri.parse(
        'https://github.com/lixingyu41/lserial/releases/download/v1.0.17/LSerial-v1.0.17-macOS.dmg',
      ),
    ),
    _DownloadTarget(
      label: 'Linux',
      icon: Icons.terminal,
      url: Uri.parse(
        'https://github.com/lixingyu41/lserial/releases/download/v1.0.17/LSerial-v1.0.17-Linux-x64.tar.gz',
      ),
    ),
    _DownloadTarget(
      label: 'Windows',
      ...
      url: Uri.parse(
        'https://github.com/lixingyu41/lserial/releases/download/v1.0.17/LSerial-v1.0.17-Windows-x64-Setup.exe',
      ),
    ),
  ];
